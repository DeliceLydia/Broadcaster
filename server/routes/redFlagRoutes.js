...
redFlag_router.patch('/api/v1/red-flags/:redFlagId/comment', auth, Redflags.updateComment);
redFlag_router.delete('/api/v1/red-flags/:redFlagId', auth, Redflags.deleteRedflag);
